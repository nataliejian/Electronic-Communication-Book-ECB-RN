...
export default class information_t extends Component {
    constructor() {
        super();
        this.state = {
            avatarSource: null,
    ...
    forceUpdateHandler(){
     ...
     //   static propTypes = {};
        ...
        navigate('T_edit_pwd',
            {
                teacher_id : this.props.navigation.getParam('id'),
                teacher_password : this.props.navigation.getParam('password'),
            });
    }   
