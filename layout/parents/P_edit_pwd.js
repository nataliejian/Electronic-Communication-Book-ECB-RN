...
export default class SignUpView extends Component {
    ...
    edit = () => {
        ...
        const { parent_phone } = this.props.navigation.state.params;
        const { parent_password } = this.props.navigation.state.params;
        if ('"' + o_pwd + '"' == parent_password) {
            fetch('http://192.168.68.112/ECB/P_edit_pwd.php', {
                method: 'post',
                header: {
                ...
                body: JSON.stringify({
                    old_password: o_pwd,
                    new_password: n_pwd,
                    phone: parent_phone.substring(1, parent_phone.length - 1),
                })
            })
