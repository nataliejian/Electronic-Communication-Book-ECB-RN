...
export default class SignUpView extends Component {
    ...
    edit = () => {
        ...
        const { child_password } = this.props.navigation.state.params;
        if ('"' + o_pwd + '"' == child_password) {
            fetch('http://192.168.68.112/ECB/S_edit_pwd.php', {
                method: 'post',
                header: {
                ...
                body: JSON.stringify({
                    old_password: o_pwd,
                    new_password: n_pwd,
                    id: child_id.substring(1, child_id.length - 1),
                })
            })
