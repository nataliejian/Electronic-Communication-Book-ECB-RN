 ...
 <Row size={0.6} >
                        <Col justifyContent='center'>
                            <TouchableOpacity
                                ...
                                onPress={() =>  this.S_add_P()}
                            >

                                <View center>
                                    <Text style={styles.editText}>新增家長資料</Text>
                                </View>
                            </TouchableOpacity>
                        </Col>
                        <Col >
                    ...
                    {/* <TouchableOpacity style={[styles.buttonContainer, styles.signupButton]} onPress={() => this.S_add_P()}>
                        <Text style={styles.signUpText}>新增家長資料</Text>
                    </TouchableOpacity> */}
                </View>
        );
    }
